...
// ────────────────────────────────────────────────────────
// Sample — three realistic Event records covering the
// online / in-person / hybrid permutations + a custom-field
// example so the JSON tester demonstrates the full surface.
// ────────────────────────────────────────────────────────
const SAMPLE = {
  items: [
    {
      name: 'React Performance Workshop',
      description: 'Three-hour deep-dive on memo/useCallback/Suspense',
      externalReferenceID: 'WS-REACT-2026-03',
      event: {
        title:            'React Performance Workshop',
        subtitle:         'Hands-on profiling and tuning',
        eventDescription: 'Bring a laptop. We profile a slow real-world app and tune it together.',
        category:         'Workshop',
    ...
    },
    {
      ...
      event: {
        ...
        postalCode:       '11181',
        country:          'Myanmar',
        googleMapLink:    'https://maps.google.com/?q=Yangon+Convention+Centre',
        website:          'https://example.com/events/q2-summit',
    ...
    {
      name: 'Smart_QR Integration 101',
      description: 'One-hour webinar for partner developers',
      externalReferenceID: 'WEB-INTEG-101',
      event: {
        title:      'Smart_QR Integration 101',
        subtitle:   'API keys, idempotency, webhooks',
        category:   'Webinar',
        startDate:  '2026-04-02',
        startTime:  '11:00',
        endTime:    '12:00',
        isOnline:   true,
        onlineLink: 'https://example.com/webinars/integration-101',
      },
      registration: {
        showEmail: true, requireEmail: true,
        showName:  true, requireName:  true,
  ...
  return (
    <main className="max-w-7xl mx-auto p-6 lg:p-8">
      <header className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900">Bulk Event create</h1>
        <p className="text-gray-500 text-sm mt-1">
          POST <code className="bg-gray-100 px-1.5 py-0.5 rounded text-xs">/api/v1/public/qr/event:batch</code> — up to 100 items per call.
