...
// ────────────────────────────────────────────────────────
// Sample — three realistic Website QR records.
  ...
  items: [
    {
      ...
      website: {
        ...
        subText:      'Redirecting you to the landing page…',
      },
    },
    {
      name: 'Developer Documentation',
      description: 'Permanent QR for printed conference handouts',
      externalReferenceID: 'DOCS-DEV-001',
      website: {
        targetUrl:    'https://docs.example.com',
        displayTitle: 'Developer Documentation',
        subText:      'Opening the docs portal…',
      },
    },
    {
      name: 'Careers Page',
      description: 'Recruitment booth banner',
      externalReferenceID: 'EVT-CONF-2026',
      website: {
        targetUrl:    'https://example.com/careers',
        displayTitle: 'Join the team',
        subText:      "We're hiring — opening the careers page…",
      },
    },
  ],
};
...
export default function WebsiteBulkPage() {
  ...
  async function submit() {
    ...
    const url = '/api/qr/website/batch';
    setRequest({
      method: 'POST',
      url,
      body: parsed,
  ...
  return (
    <main className="max-w-7xl mx-auto p-6 lg:p-8">
      <header className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900">Bulk Website create</h1>
        <p className="text-gray-500 text-sm mt-1">
          POST <code className="bg-gray-100 px-1.5 py-0.5 rounded text-xs">/api/v1/public/qr/website:batch</code> — up to 100 items per call.
